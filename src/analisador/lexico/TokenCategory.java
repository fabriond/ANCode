...
public enum TokenCategory {
    ...
    funReturn(15), paramBegin(16), paramEnd(17), lineEnd(18), commaSep(19), loopSep(20), intCons(21), 
    ...
    estIf(37), estElsif(38), estElse(39), estLoop(40), estDo(41), estWhile(42), instRead(43), instPrint(44), 
    unknown(45);
